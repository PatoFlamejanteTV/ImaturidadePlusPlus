...
function onUpdate(elapsed)
  if curStep >= 0 then
    ...
    local currentBeat = (songPos/1000)*(bpm/150) --(songPos/1000)*(bpm/200)
    doTweenY(dadTweenY, 'dad', 290-130*math.sin((currentBeat*0.25)*math.pi),0.001)
	doTweenX(dadTweenX, 'dad', 290-130*math.cos((currentBeat*0.25)*math.pi),0.001)
	--doTweenY(playerTweenY, 'bf', 290-130*math.sin((currentBeat*0.25)*math.pi),0.001)
	--doTweenX(playerTweenX, 'bf', 290-130*math.cos((currentBeat*0.25)*math.pi),0.001)
  end
end

local angleshit = 4; --local angleshit = 2;
local anglevar = 2;
function onBeatHit()
  if curBeat < 300 then
    ...
    noteTweenX("x1",0,25,10,"quadinOut");
   --("y1",0,25,1,"quadinOut");
 
    noteTweenX("x2",1,25,10,"quadinOut");
   --("y2",1,25,1,"quadinOut");
 
  
    noteTweenX("x3",2,25,10,"quadinOut");
   --("y3",2,25,1,"quadinOut");
   


    noteTweenX("x4",3,25,10,"quadinOut");
   --("y4",3,25,1,"quadinOut");
  
   

    noteTweenX("x5",4,25,10,"quadinOut");
   --("y5",4,25,1,"quadinOut");
  


    noteTweenX("x6",5,25,10,"quadinOut");
   --("y6",5,25,1,"quadinOut");
   

    noteTweenX("x7",6,25,10,"quadinOut");
   --("y7",6,25,1,"quadinOut");
 

    noteTweenX("x8",7,25,10,"quadinOut");
   --("y8",7,25,1,"quadinOut");
