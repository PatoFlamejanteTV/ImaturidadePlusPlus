...
local currentBeat = (songPos/5000)*(curBpm/24)
	...
	noteTweenY('OpponentStrumY0', 0, defaultOpponentStrumY0 + (math.tan((currentBeat) + 0) * 600), 0.05)
	noteTweenY('OpponentStrumY1', 1, defaultOpponentStrumY1 + (math.tan((currentBeat) + 1) * 600), 0.05)
	noteTweenY('OpponentStrumY2', 2, defaultOpponentStrumY2 + (math.tan((currentBeat) + 2) * 600), 0.05)
	noteTweenY('OpponentStrumY3', 3, defaultOpponentStrumY3 + (math.tan((currentBeat) + 3) * 600), 0.05)
	end